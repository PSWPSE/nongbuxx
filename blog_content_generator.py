...
**🌟 창의적 콘텐츠 작성 원칙:**
- **원본 뉴스 제목을 절대 그대로 사용하지 마세요**
- **완전히 새로운 관점과 스토리텔링으로 재구성된 블로그 콘텐츠를 작성하세요**
- **원본 뉴스의 팩트를 기반으로 하되, AI의 분석과 인사이트를 대폭 추가하세요**
- **독자에게 더 큰 가치를 제공하는 심층적이고 창의적인 콘텐츠를 만드세요**
...
**💡 창의적 제목 생성 가이드라인 (핵심):**
- **원본 제목과 완전히 다른 각도에서 접근한 새로운 제목 필수**
- 같은 사실을 다른 시각으로 해석한 참신한 제목
- "알고 보니", "진짜 이유", "숨겨진 비밀", "의외의 진실" 등 호기심 유발
- 스토리텔링과 감정을 자극하는 제목
- 예시:
  * 원본: "삼성전자 3분기 실적 발표"
  * 창의적 제목: "삼성이 조용히 준비하는 차세대 먹거리의 정체"
  * 창의적 제목: "실적 뒤에 숨겨진 삼성의 대담한 베팅"
...
**🖼️ 이미지 추가 가이드라인:**
- **이미지 플레이스홀더 제공**: 콘텐츠 적절한 위치에 이미지 삽입 권장 사항 표시
- **형식**: <div style="background-color: #e3f2fd; padding: 40px; text-align: center; margin: 2em 0; border: 2px dashed #1976d2; border-radius: 8px;"><p style="color: #1976d2; font-weight: 600;">[이미지 추천: 설명]</p><p style="color: #555; font-size: 0.9em;">예: "AI 기술 발전을 시각화한 인포그래픽" 또는 "관련 제품 이미지"</p></div>
- **이미지 위치**: 주요 섹션 시작 부분이나 핵심 내용 설명 후 배치
- **이미지 설명**: 각 이미지 플레이스홀더에 구체적인 이미지 추천 사항 포함
- **주의사항**: 실제 이미지 URL은 포함하지 않고, 사용자가 적절한 이미지를 찾아 삽입할 수 있도록 가이드만 제공
