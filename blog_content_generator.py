...
- 예시:
  * "연준 금리 인하 발표" → "연준 금리 인하 발표, 글로벌 금융시장에 미치는 충격적 영향"
  * "삼성전자 실적 발표" → "삼성전자 실적 호조, 전문가들이 주목하는 숨겨진 위험신호"
...
- 예시 변환:
  * "Fed cuts interest rates" 
    → "연준 금리 인하 발표, 글로벌 금융시장에 미치는 충격적 영향"
  * "Apple announces new AI features"
    → "애플 AI 신기능 공개, 전문가들이 경고하는 숨겨진 위험신호"
  * "Tesla stock rises 5%"
    → "테슬라 주가 5% 급등, 투자자들이 놓치고 있는 위험요소"
  * "Market volatility increases"
    → "시장 변동성 확대, 전문가들이 경고하는 2024년 투자 위험요소"
